    ...
    if userName != '' and pwd != '':
        try:
            ...
            if pwd == visitUser.user_passwd:
                ...
                # if user name and password is correct, get inventory info from database and show them in inventory_page.html
                goods_list = goods.objects.all()
                return render(request, 'inventory_module/inventory/inventory_page.html',{'user_name':userName, 'passwd':pwd, 'goods_list': goods_list})
